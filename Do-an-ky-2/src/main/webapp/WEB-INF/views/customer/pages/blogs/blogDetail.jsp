			...
			<div class="col-lg-12 posts-list">
					...
					<div class="d-sm-flex justify-content-between text-center">
						...
						<div class="col-sm-4 text-center my-2 my-sm-0">
							<p class="comment-count">
								<span class="align-middle"><i class="ti-comment"></i></span> 06
								Comments
							</p>
						</div>
					...
					<div class="navigation-area">
						<div class="row">
							<div
								...
								<div class="thumb">
									<a href="#"> <img class="img-fluid" src="<c:url value="assets"/>/customer/img/blog/prev.jpg"
										alt="">
									</a>
								</div>
								<div class="arrow">
									<a href="#"> <span class="ti-arrow-left text-white"></span>
									</a>
								</div>
								<div class="detials">
									<p>Prev Post</p>
							...
							<div
								...
								<div class="arrow">
									<a href="#"> <span class="ti-arrow-right text-white"></span>
									</a>
								</div>
								<div class="thumb">
									<a href="#"> <img class="img-fluid" src="<c:url value="assets"/>/customer/img/blog/next.jpg"
										alt="">
									</a>
								</div>
							</div>
				...
				<div class="blog-author">
					<div class="media align-items-center">
						<img src="<c:url value="assets"/>/customer/img/blog/author.png" alt="">
				...
				<div class="comments-area">
					...
					<div class="comment-list">
						<div class="single-comment justify-content-between d-flex">
							<div class="user justify-content-between d-flex">
								<div class="thumb">
									<img src="<c:url value="assets"/>/customer/img/blog/c1.png" alt="">
								</div>
								<div class="desc">
					...
					<div class="comment-list">
						<div class="single-comment justify-content-between d-flex">
							<div class="user justify-content-between d-flex">
								<div class="thumb">
									<img src="<c:url value="assets"/>/customer/img/blog/c2.png" alt="">
								</div>
								<div class="desc">
									<p class="comment">Multiply sea night grass fourth day sea
										lesser rule open subdue female fill which them Blessed, give
					...
					<div class="comment-list">
						<div class="single-comment justify-content-between d-flex">
							<div class="user justify-content-between d-flex">
								<div class="thumb">
									<img src="<c:url value="assets"/>/customer/img/blog/c3.png" alt="">
								</div>
								<div class="desc">
									<p class="comment">Multiply sea night grass fourth day sea
										lesser rule open subdue female fill which them Blessed, give

					...
					<tbody>
						<tr>
							<td>
								<div class="media">
									<div class="d-flex">
										<img src="<c:url value="assets"/>/customer/img/product/single-product/cart-1.jpg" alt="" />
									</div>
							...
							<td>
								<div class="cupon_text">
									<input type="text" placeholder="Coupon Code" /> <a
										class="main_btn" href="#">Apply</a> <a class="gray_btn"
										href="#">Close Coupon</a>
								</div>
							</td>
						</tr>
						...
						<tr class="out_button_area">
							...
							<td>
								<div class="checkout_btn_inner">
									<a class="gray_btn" href="category">Continue Shopping</a> <a
										class="main_btn" href="checkOut">Proceed to checkout</a>
								</div>
							</td>
						</tr>
					</tbody>

	...
	<div class="container">
		<div class="row">
			<div class="col-lg-3 col-md-6 single-footer-widget">
				<h4>Eiser shop</h4>
				<p>Lorem ipsum amet adipisicing elit. Voluptatem molestias accusantium quia dolorem nobis suscip</p>
			</div>
			<div class="col-lg-3 col-md-6 single-footer-widget">
				<h4>Contact</h4>
				<ul>
					<li><a href="#">Address: ${config.address}</a></li>
					<li><a href="#">Phone: ${config.phone}</a></li>
